...
lupine_major := 0
lupine_minor := 0
lupine_reltype := alpha
lupine_version_string := Lupine $(lupine_major).$(lupine_minor)-$(lupine_reltype)
...
lupine: dirs generate_version_file $(lupine_libso) $(lupine_liba) lupine_include
...
generate_version_file:
	@echo "Generating lib/lupine_version.h..."
	@echo "//" > $(lupine_sourcedir)/lupine_version.h
	@echo "// This file is automatically generated by the build system, do not edit!!" >> $(lupine_sourcedir)/lupine_version.h
	@echo "// Generated by make on $(shell date)" >> $(lupine_sourcedir)/lupine_version.h
	@echo "//" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#ifndef LUPINE_VERSION_H_INCLUDED" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#define LUPINE_VERSION_H_INCLUDED" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#define LUPINE_MAJOR $(lupine_major)" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#define LUPINE_MINOR $(lupine_minor)" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#define LUPINE_RELTYPE \"$(lupine_reltype)\"" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#define LUPINE_VERSION_STRING \"$(lupine_version_string)\"" >> $(lupine_sourcedir)/lupine_version.h
	@echo "#endif" >> $(lupine_sourcedir)/lupine_version.h
